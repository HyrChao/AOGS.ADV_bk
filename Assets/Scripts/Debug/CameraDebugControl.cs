...
public class CameraDebugControl : MonoBehaviour {
    ...
    //private void Awake()
    //{
    //    focusPoint = this.transform.position + focus * this.transform.forward;
    //}
    ...
    //    m_hAxis = Input.GetAxis("Mouse X");
    //    m_vAxis = Input.GetAxis("Mouse Y");

    //    float yaw = m_vAxis;
    //    float pitch = -m_hAxis;
    //    float rotateRate = turnSpeed * Time.deltaTime;
    //    //Vector3 rotateAxis = new Vector3(10, 0, 0);

    //    //transform.LookAt(focusPoint);
    //    //Vector3 rotateAxis = new Vector3(yaw, pitch, 0);
    //    //Vector3 currentEulerRotation = transform.rotation.eulerAngles;
    //    //Quaternion rotateVar = Quaternion.Euler(yaw + currentEulerRotation.x, pitch + currentEulerRotation.y, 0);
    //    transform.Rotate(yaw*rotateRate,pitch*rotateRate, 0);
    //    //transform.RotateAround(rotateAxis, focusPoint, rotateRate);
    //    //transform.RotateAround(rotateAxis, focusPoint, rotateRate);
    //    //transform.rotation = rotateVar;


    //    Vector3 forwardMovenment = transform.forward * Time.deltaTime * moveSpeed * vAxis;
    //    Vector3 rightMovenment = transform.right * Time.deltaTime * moveSpeed * hAxis;
    //    Vector3 movement = forwardMovenment + rightMovenment;
